...
class CreateAuthTables extends Migration
{
    public function up()
    {
        ...
        $this->forge->addField([
            ...
            'username'         => ['type' => 'varchar', 'constraint' => 99, 'null' => true],
            'unit_kerja'       => ['type' => 'varchar', 'constraint' => 255],
            'jabatan'          => ['type' => 'varchar', 'constraint' => 155],
            'telpon'           => ['type' => 'varchar', 'constraint' => 55],
