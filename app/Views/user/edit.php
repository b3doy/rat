    ...
    <div class="row">
        <div class="col-md-6">
            <div class="row">
                ...
                <div class="col-md-2">
                    <a href="<?= base_url('user/index'); ?>" class="btn btn-dark" data-bs-toggle="tooltip" data-bs-placement="top" title="Kembali Ke Menu Sebelumnya"><i class="fa fa-undo"></i> </a>
                </div>
            </div>
...
<script>
    function desc() {
        ...
        if (groupid == "1") {
            ...
            document.getElementById('description').value = "Auditor"
        } else if (groupid == "3") {
