...
<div class="container mt-3">
    <div class="row">
        <div class="col-md-8">
            <h2><u>Input Data Penerapan Manajemen Resiko</u></h2>
        </div>
        <div class="col-md-2">
    ...
    <form action="<?= base_url('/pmr/save'); ?>" class="mt-3" method="POST" enctype="multipart/form-data">
        <?= csrf_field(); ?>
        <div class="form-group row">
            <label for="tahun" class="col-sm-2 col-form-label">Tahun</label>
            <div class="col-sm-6">
                <input type="number" name="tahun" id="tahun" class="form-control <?= ($validasi->hasError('tahun')) ? 'is-invalid' : ''; ?>" value="<?= old('tahun'); ?>" autofocus>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" name="kld" class="form-control" id="kld" value="Kementerian Agama RI" readonly>
            </div>
        </div>
        <div class="form-group row">
            <label for="nama_unit" class="col-sm-2 col-form-label">Nama Unit</label>
            <div class="col-sm-6">
                <input type="text" name="nama_unit" class="form-control" id="nama_unit" value="<?= user()->unit_kerja; ?>" readonly>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <select name="level_mr_eselon" class="form-control <?= ($validasi->hasError('level_mr_eselon')) ? 'is-invalid' : ''; ?>" id="level_mr_eselon">
                    ...
                    <option value="<?= old('level_mr_eselon'); ?>"><?= old('level_mr_eselon'); ?></option>
                </select>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" name="nama_level_unit" id="nama_level_unit" class="form-control <?= ($validasi->hasError('nama_level_unit')) ? 'is-invalid' : ''; ?>" value="<?= old('nama_level_unit'); ?>">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <textarea name="ruang_lingkup_penerapan" id="ruang_lingkup_penerapan" class="form-control <?= ($validasi->hasError('ruang_lingkup_penerapan')) ? 'is-invalid' : ''; ?>"><?= old('ruang_lingkup_penerapan'); ?></textarea>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="number" name="periode" id="periode" class="form-control <?= ($validasi->hasError('periode')) ? 'is-invalid' : ''; ?>" value="<?= old('periode'); ?>">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" name="output" id="output" class="form-control <?= ($validasi->hasError('output')) ? 'is-invalid' : ''; ?>" value="<?= old('output'); ?>">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <select name="data_sudah_benar" id="data_sudah_benar" class="form-control <?= ($validasi->hasError('data_sudah_benar')) ? 'is-invalid' : ''; ?>">
                    ...
                    <option value="<?= old('data_sudah_benar'); ?>"><?= old('data_sudah_benar'); ?></option>
                </select>
