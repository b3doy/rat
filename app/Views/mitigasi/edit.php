...
<div class="container mt-3">
    <div class="row">
        <div class="col-md-10">
            <h2>Edit Data Mitigasi Resiko / Rencana Tindak Pengendalian (RTP)</h2>
        </div>
        <div class="col-md-2">
            <a href="<?= base_url('/mitigasi/detail/' . $mitigasi['pmr_id']); ?>" class="btn btn-dark" data-bs-toggle="tooltip" data-bs-placement="top" title="Kembali Ke Menu Sebelumnya"><i class="fa fa-undo"></i> </a>
        </div>
    </div>
    <!-- Form Tambah Data -->
    <form action="<?= base_url('/mitigasi/update/' . $mitigasi['id']); ?>" class="mt-3 ml-3" method="post" enctype="multipart/form-data">
        <?= csrf_field(); ?>
        <div class="form-group row">
            <label for="mitigasi_kejadian" class="col-sm-2 col-form-label">Kejadian</label>
            <div class="col-sm-6">
                <textarea name="mitigasi_kejadian" id="mitigasi_kejadian" class="form-control <?= ($validasi->hasError('mitigasi_kejadian')) ? 'is-invalid' : ''; ?>" readonly><?= $mitigasi['mitigasi_kejadian']; ?></textarea>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" name="mitigasi_prioritas_resiko" id="mitigasi_prioritas_resiko" class="form-control <?= ($validasi->hasError('mitigasi_prioritas_resiko')) ? 'is-invalid' : ''; ?>" value="<?= $mitigasi['mitigasi_prioritas_resiko']; ?>" readonly>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" name="mitigasi_no_reg_resiko" id="mitigasi_no_reg_resiko" class="form-control <?= ($validasi->hasError('mitigasi_no_reg_resiko')) ? 'is-invalid' : ''; ?>" value="<?= $mitigasi['mitigasi_no_reg_resiko']; ?>" readonly>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" name="opsi_mitigasi" id="opsi_mitigasi" class="form-control <?= ($validasi->hasError('opsi_mitigasi')) ? 'is-invalid' : ''; ?>" value="<?= $mitigasi['opsi_mitigasi']; ?>" readonly>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <textarea name="keg_pengendalian_tambahan" id="keg_pengendalian_tambahan" class="form-control <?= ($validasi->hasError('keg_pengendalian_tambahan')) ? 'is-invalid' : ''; ?>" autofocus><?= $mitigasi['keg_pengendalian_tambahan']; ?></textarea>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" name="target" id="target" class="form-control <?= ($validasi->hasError('target')) ? 'is-invalid' : ''; ?>" value="<?= $mitigasi['target']; ?>">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" name="jadwal_implementasi" id="jadwal_implementasi" class="form-control <?= ($validasi->hasError('jadwal_implementasi')) ? 'is-invalid' : ''; ?>" value="<?= $mitigasi['jadwal_implementasi']; ?>">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" name="penanggung_jawab" id="penanggung_jawab" class="form-control <?= ($validasi->hasError('penanggung_jawab')) ? 'is-invalid' : ''; ?>" value="<?= $mitigasi['penanggung_jawab']; ?>">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <select name="level_kemungkinan" id="level_kemungkinan" class="form-control <?= ($validasi->hasError('level_kemungkinan')) ? 'is-invalid' : ''; ?>" onchange="resiko()">
                    ...
                    <?php endforeach; ?>
                    <option value="<?= $mitigasi['mitigasi_level_kemungkinan']; ?>" selected><?= $mitigasi['mitigasi_level_kemungkinan']; ?></option>
                </select>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <select name="level_dampak" id="level_dampak" class="form-control <?= ($validasi->hasError('level_dampak')) ? 'is-invalid' : ''; ?>" onchange="resiko()">
                    ...
                    <?php endforeach; ?>
                    <option value="<?= $mitigasi['mitigasi_level_dampak']; ?>" selected><?= $mitigasi['mitigasi_level_dampak']; ?></option>
                </select>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                <input type="text" name="level_resiko" id="level_resiko" class="form-control <?= ($validasi->hasError('level_resiko')) ? 'is-invalid' : ''; ?>" value="<?= $mitigasi['mitigasi_level_resiko']; ?>" readonly>
                <div id="level_resiko" class="invalid-feedback">
                    <?= $validasi->getError('level_resiko'); ?>
                </div>
            </div>
            <div class="col-sm-3 row">
                <input type="text" name="tingkat_level_resiko" id="tingkat_level_resiko" class="form-control" value="<?= $mitigasi['mitigasi_tingkat_level_resiko']; ?>" readonly>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <select name="mitigasi_dilaksanakan" id="mitigasi_dilaksanakan" class="form-control <?= ($validasi->hasError('mitigasi_dilaksanakan')) ? 'is-invalid' : ''; ?>">
                    ...
                    <option value="<?= $mitigasi['mitigasi_dilaksanakan']; ?>" selected><?= $mitigasi['mitigasi_dilaksanakan']; ?></option>
                </select>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <textarea name="capaian_target" id="capaian_target" class="form-control <?= ($validasi->hasError('capaian_target')) ? 'is-invalid' : ''; ?>"><?= $mitigasi['capaian_target']; ?></textarea>
        ...
        <input type="hidden" name="pmr_id" value="<?= $mitigasi['pmr_id']; ?>">
        <input type="hidden" name="identifikasi_id" value="<?= $mitigasi['identifikasi_id']; ?>">
        <input type="hidden" name="id" value="<?= $mitigasi['id']; ?>">
