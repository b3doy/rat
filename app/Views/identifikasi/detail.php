...
<div class="card bg-transparent">
    ...
    <div class="row">
        <div class="col">
            <h2 class="ml-3"><u>Profile / Identifikasi Resiko</u></h2>
            <div class="row">
                <div class="col-md-4">
    ...
    <div class="row mb-3">
        <div class="col">
            <a href="<?= base_url('/identifikasi/create/' . $pmr['id']) ?>" class="btn btn-outline-success btn-sm mx-3"><i class="fa fa-plus-circle"></i> Input Data</a>

            <a href="<?= base_url('/identifikasi'); ?>" class="btn btn-sm btn-outline-dark">
    ...
    <div class="row">
        <div class="col">
            <div class="table-responsive mt-3">
                <table class="table-sm table-bordered table-hover text-xs" id="identifikasiTable">
                    <?php if ($identifikasiThead != null) : ?>
                        <thead>
                            <tr>
                                <th>No</th>
...
<script>
    table = $('#identifikasiTable').DataTable({
        "order": [],
        "processing": true,
        "serverside": true,
        "ajax": {
            "url": "<?= base_url('/identifikasi/identifikasiTable'); ?>",
            "type": "POST",
            "data": {
                pmr_id: $('#pmr_id').val()
            }
